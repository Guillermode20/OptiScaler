...
- KCD2 input-predicted yaw composes around CryEngine world Z, then pitch composes around the yawed camera-right axis. Never yaw around the camera's local up vector: it tilts with pitch and produces roll/diagonal movement when panning horizontally while looking steeply up or down.
