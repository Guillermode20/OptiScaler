...
* Remove the ineffective KCD2 render-reserve control and crop after live testing showed no wider captured world coverage
* Fail-closed FSR midpoint gates (dimension/scale sanity and unified camera-interval time base)

## v10.0.1.49 (2026-09-06)
* Attempt KCD2 peripheral reserve (subsequently removed after live testing showed it only cropped the image) and correct hybrid FSR motion inputs

## v10.0.1.48 (2026-09-06)
* Edge-trigger hybrid resets and add an experimental fixed warp guard crop (subsequently removed)
...
## v10.0.1.16 (2026-09-02)
* reproj: advance source pacer deadline on slight overshoots to prevent 55fps drift, enable lightweight camera EMA smoothing, and increase late latch lead to 3.5ms

## v10.0.1.15 (2026-09-02)
* reproj: fix sourceCutGeneration field name in ApplyLateInput
...
## v10.0.1.2 (2026-08-31)
* Stabilize KCD2 timewarp cadence and camera rotation
...
## v10.0.0.34 (2026-08-30)
* Hybrid frame generation and scanout-time late warp
...
## v0.7.0-pre92
* Added one line horizontal layout for Fps Overlay (thanks to **TheRazerMD** 😁)
