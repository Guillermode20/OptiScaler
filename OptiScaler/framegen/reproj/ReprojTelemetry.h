...
struct ReprojSlotRecord
{
    ...
    float lateInputSensX = 0.0f;
    float lateInputSensY = 0.0f;
...
struct ReprojTelemetrySnapshot
{
    ...
    float trackedSensX = std::numeric_limits<float>::quiet_NaN();
    float trackedSensY = std::numeric_limits<float>::quiet_NaN();
